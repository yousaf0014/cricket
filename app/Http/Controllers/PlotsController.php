...
class PlotsController extends Controller {
    ...
    public function index() {
        ...
        $data['itemData'] = (new Item)->getAllItemByCat($cat);
        $data['itemQuantity'] = DB::table('stock_moves')
                ->select(DB::raw('SUM(qty) as total_item'))
                ->join('item_code', 'stock_moves.stock_id', '=', 'item_code.stock_id')
                ->join('stock_category', 'item_code.category_id', '=', 'stock_category.category_id')
                ->where([
                    ['stock_category.category_id', '=', $cat],
                    ['deleted_status', '=', '0'],
                ])
                ->first();
        $itemList = $this->report->getInventoryStockOnHandByCat('all', 'all', $cat);
        //d($itemList,1);
        ...
        return view('admin.plots.plots_list', $data);
    }
    ...
    public function create($tab) {
        ...
        return view('admin.plots.plots_add', $data);
    }
    ...
    public function store(Request $request) {
        ...
        if (!empty($id)) {
            ...
            return redirect()->intended("edit-plots/plots-info/$id");
        } else {
     ...
     *
      ...
      return redirect()->intended('create-plots/purchase');
     ...
     *
      ...
      return redirect()->intended("edit-plots/sales-info/$id");
      }else{

      DB::table('sale_prices')->insert($data);
      \Session::flash('success',trans('message.success.update_success'));
      return redirect()->intended('edit-plots/sales-info/'.$request->plots_id);
      }
      ...
      return redirect()->intended('edit-plots/sales-info/'.$plots_id);
      }
      }
      }
     ...
     *
      ...
      \Session::flash('success',trans('message.success.update_success'));
      return redirect()->intended('edit-plots/purchase-info/'.$request->plots_id);
      }
      /**
     * Store a newly created plots  purchase price in storage.
     * @param  \Illuminate\Http\Request  $request
     ...
     *
      ...
      \Session::flash('success',trans('message.success.save_success'));
      DB::table('purchase_prices')->insert($data);
      return redirect()->intended('plots');
    ...
    public function show($id) {
        ...
        return view('admin.plots.plots_show', $data);
    }
    ...
    public function edit($id) {
        ...
        $data['plotInfo'] = DB::table('plots')
                ...
                ->select('*')
                ->first();
        return view('admin.plots.plots_edit', $data);
    }
    ...
    public function copy($id) {
        ...
        return view('admin.plots.plots_copy', $data);
    }
    ...
    public function updateplotInfo(Request $request) {
        ...
        DB::table('plots')->where('plot_id', $request->plot_id)->update($data);


        Session::flash('success', trans('message.success.update_success'));
        return redirect()->intended('edit-plot/' . $request->plot_id);
    }
     ...
     *
      ...
      return redirect()->intended("show-plots/$id");
      }
      }
    ...
    public function showFullDetails($id) {
        ...
        return view('admin.plots.plots_transition', $data);
    }
...
//d($plotsdata,1);
    ...
    public function import() {
        ...
        return view('admin.plots.plots_import', $data);
    }
    ...
    public function importCsv(Request $request) {
        ...
        if (Input::hasFile('import_file')) {
            ...
            //d($csv,1);
            $unMatch = [];
            $header = array("Plot ID", "plots Name", "Long Description", "plots Category", "Unit", "Tax Type", "Purchase Price", "Retail Price", "Wholesale Price");
