    ...
    <section class="content">
      ...
      <div class="box">
            ...
            <div class="box-header">
              <a href="{{ URL::to('plotdownloadcsv/csv') }}"><button class="btn btn-default btn-flat btn-border-info"><span class="fa fa-download"> &nbsp;</span>{{ trans('message.table.download_csv') }}</button></a>
            </div>
