          ...
          <div class="nav-tabs-custom" id="tabs">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                ...
                <form action="{{ url('save-plot') }}" method="post" id="plotAddForm" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="box-footer">
                    <a href="{{ url('plots') }}" class="btn btn-info btn-flat">{{ trans('message.form.cancel') }}</a>
