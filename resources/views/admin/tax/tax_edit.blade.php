      ...
      <!-- Default box -->
        <div class="row">
          <div class="col-md-offset-3 col-md-6">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action='{{ url("update-tax/$taxData->id") }}' method="post" id="myform1" class="form-horizontal">
            {!! csrf_field() !!}
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="inputEmail3">{{ trans('message.table.unit_name') }}</label>
                  <div class="col-sm-10">
                    <input type="text" value="{{$taxData->name}}" class="form-control valdation_check" id="name" name="name">
              ...
              <div class="box-footer">
                <a href="{{ url('tax') }}" class="btn btn-default">{{ trans('message.form.cancel') }}</a>
