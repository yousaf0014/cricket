            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                ...
                <div class="col-md-6">
                  ...
                  <form action="{{ url('update-plot-info-management') }}" method="post" id="itemEditForm" class="form-horizontal" enctype="multipart/form-data">
                    <input type="hidden" value="{{csrf_token()}}" name="_token" id="token">
                    <input type="hidden" value="{{$plotInfo->pid}}" name="pid">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          ...
                          @endif
                         <input type="hidden" name="pic" value="{{ $plotInfo->plot_img ? $plotInfo->plot_img : 'NULL' }}">
