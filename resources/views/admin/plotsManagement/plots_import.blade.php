        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <a href="{{ URL::to('plotManagementdownloadcsv/sample') }}"><button class="btn btn-default btn-flat btn-border-info">Download Sample</button></a>
            </div>
            <div class="box-body">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="{{ url('plotManagementimportcsv') }}" method="post" id="myform1" class="form-horizontal" enctype="multipart/form-data">
            {!! csrf_field() !!}
              ...
              <div class="box-footer">
                <a href="{{ url('plots-management/list') }}" class="btn btn-info btn-flat">{{ trans('message.form.cancel') }}</a>
