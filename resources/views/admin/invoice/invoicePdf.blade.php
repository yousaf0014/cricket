  ...
  <div style="width:300px; float:left;">
    <div style="margin-top:20px;">
      ...
      @if($saleDataInvoice->paid_amount == 0)
        <div style="font-size:16px; font-weight:bold" >Status : Unpaid</div>
      @elseif($saleDataInvoice->paid_amount > 0 && $saleDataInvoice->total > $saleDataInvoice->paid_amount )
        <div style="font-size:16px; font-weight:bold" >Status : Partially paid</div>
      @elseif($saleDataInvoice->total<=$saleDataInvoice->paid_amount)
        <div style="font-size:16px; font-weight:bold" >Status : Paid</div>
      @endif
